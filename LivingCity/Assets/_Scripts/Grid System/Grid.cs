...
public class Grid
{
    ...
    private List<Point> _pavementList = new List<Point>();  
    private List<Point> _specialStructure = new List<Point>();
    private List<Point> _houseStructure = new List<Point>();
    private List<Point> _carSpawner = new List<Point>();
    private List<Point> _carDespawner = new List<Point>();
    ...
    public CellType this[int i, int j]
    {
        ...
        set
        {
            ...
            if (value == CellType.Pavement)
            {
                _pavementList.Add(new Point(i, j));
            }
            ...
            if (value == CellType.CarSpawner)
            {
                _carSpawner.Add(new Point(i, j));
            }
            if (value == CellType.CarDespawner)
            {
                _carDespawner.Add(new Point(i, j));
            }
            _grid[i, j] = value;
        }
    }
    ...
    public Point GetRandomPavementPoint()
    {
        Random rand = new Random();
        return _pavementList[rand.Next(0, _pavementList.Count - 1)];
    }
    ...
    public Point GetRandomCarSpawnerPoint()
    {
        if (_carSpawner.Count == 0)
        {
            return null;
        }
        return _carSpawner[UnityEngine.Random.Range(0, _carSpawner.Count)];
    }

    public Point GetRandomCarDespawnerPoint()
    {
        if (_carDespawner.Count == 0)
        {
            return null;
        }
        return _carDespawner[UnityEngine.Random.Range(0, _carDespawner.Count)];
    }
    ...
    public List<Point> GetAllCarSpawner()
    {
        return _carSpawner;
    }

    public List<Point> GetAllCarDespawner()
    {
        return _carDespawner;
    }
